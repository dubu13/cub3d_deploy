...
// include: /tmp/tmp5gkkb04j.js
  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'cub3D_web.data';
      var REMOTE_PACKAGE_BASE = 'cub3D_web.data';
...
Module['FS_createPath']("/maps", "invalid", true, true);
Module['FS_createPath']("/maps", "valid", true, true);
Module['FS_createPath']("/", "textures", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_cub3D_web.data');

      }
      Module['addRunDependency']('datafile_cub3D_web.data');
    ...
    loadPackage({"files": [{"filename": "/maps/invalid/char.cub", "start": 0, "end": 564}, {"filename": "/maps/invalid/color.cub", "start": 564, "end": 1128}, {"filename": "/maps/invalid/extention.cubcub", "start": 1128, "end": 1128}, {"filename": "/maps/invalid/player.cub", "start": 1128, "end": 1691}, {"filename": "/maps/invalid/texture.cub", "start": 1691, "end": 2253}, {"filename": "/maps/invalid/wall.cub", "start": 2253, "end": 2815}, {"filename": "/maps/valid/map.cub", "start": 2815, "end": 3396}, {"filename": "/textures/east.png", "start": 3396, "end": 3679}, {"filename": "/textures/north.png", "start": 3679, "end": 4031}, {"filename": "/textures/south.png", "start": 4031, "end": 4353}, {"filename": "/textures/west.png", "start": 4353, "end": 4617}], "remote_package_size": 4617});

  })();

// end include: /tmp/tmp5gkkb04j.js
// include: /tmp/tmp1ggkwkl2.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmp1ggkwkl2.js
// include: /tmp/tmpbn5mtulu.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpbn5mtulu.js
...
function findWasmBinary() {
    return locateFile('cub3D_web.wasm');
}
